  ...
  if (!mode || (mode === 'instagram' && !instagramReady) || (mode === 'facebook' && !facebookReady)) {
    ...
    return res.status(503).json({
      ...
      message: mode === 'instagram'
        ...
        : 'Facebook Login nie jest skonfigurowany. Ustaw META_FACEBOOK_APP_ID i META_FACEBOOK_APP_SECRET albo jawnie META_APP_ID i META_APP_SECRET jako legacy Facebook App.',
      mode: mode || null,
      instagramReady,
      facebookReady,
